                        ...
                        <div class="col-lg-4 card">
                            ...
                            <form method="POST" action="{{ route('company.update', $editCompany->id) }}">
                                ...
                                <div class="form-outline mb-4">
                                    <input type="hidden" id="form3Example3" name="id"
                                        value="{{ $editCompany['id'] }}">
                                    <label class="form-label" for="form3Example3">Name</label>
                                    <input type="text" id="form3Example3" name="name"
                                        value="{{ $editCompany['name'] }}" class="form-control form-control-lg"
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <input type="email" id="form3Example3" name="email"
                                        value="{{ $editCompany['email'] }}" class="form-control form-control-lg"
